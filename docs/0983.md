> 原文:[http://web . archive . org/web/20230101150211/http://www . mkyong . com/Google-app-engine/Google-app-engine-spring-3-MVC-rest-example/](http://web.archive.org/web/20230101150211/http://www.mkyong.com/google-app-engine/google-app-engine-spring-3-mvc-rest-example/)
...
![gae spring new web application](../Images/411ea23f21e3689d006bc745a8029e2f.png "gae-spring-example1")
...
![gae spring dependency library](../Images/f53e0967f8dd8e7dc9921180c1c2c191.png "gae-spring-library-example2")

将其添加到项目的构建路径中——右键单击项目文件夹，选择“ **Properties** ”。选择“ **Java 构建路径**->-**库**”选项卡，点击“**添加 Jars** 按钮，选择上面的 Jars。

![gae spring java build path](../Images/c9d8164f9c373fad994a0871b4cac480.png "gae-spring-java-build-example3") <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-2836379775501347" data-ad-slot="8821506761" data-ad-format="auto" data-ad-region="mkyongregion">## 3.弹簧控制器
...
![gae spring final directory structure](../Images/8af8b6a949eb79c78192a3775c20dfb3.png "gae-spring-final-directory-example4")
...
![gae spring deploy on local development environemnt](../Images/1a3f99d1696244be709c9b79cdd7a294.png "gae-spring-local-output-example5")
...
![gae spring deploy on production environment](../Images/68edd6b4b54363131c692805780a113d.png "gae-spring-production-example6")

> 原文:[http://web . archive . org/web/20230101150211/https://mkyong . com/spring-boot/spring-rest-integration-test-example/](http://web.archive.org/web/20230101150211/https://mkyong.com/spring-boot/spring-rest-integration-test-example/)

# 弹簧座集成测试示例

![spring boot test](../Images/1f34bbe7c7748420e5c1b235bea07530.png)
...
[spring boot](http://web.archive.org/web/20190311102322/http://www.mkyong.com/tag/spring-boot/) [spring test](http://web.archive.org/web/20190311102322/http://www.mkyong.com/tag/spring-test/) [unit test](http://web.archive.org/web/20190311102322/http://www.mkyong.com/tag/unit-test/)</ins></ins>![](../Images/c9e18b26c1780e6725bfc904fc429647.png) (function (i,d,s,o,m,r,c,l,w,q,y,h,g) { var e=d.getElementById(r);if(e===null){ var t = d.createElement(o); t.src = g; t.id = r; t.setAttribute(m, s);t.async = 1;var n=d.getElementsByTagName(o)[0];n.parentNode.insertBefore(t, n); var dt=new Date().getTime(); try{i[l][w+y](h,i[l][q+y](h)+'&amp;'+dt);}catch(er){i[h]=dt;} } else if(typeof i[c]!=='undefined'){i[c]++} else{i[c]=1;} })(window, document, 'InContent', 'script', 'mediaType', 'carambola_proxy','Cbola_IC','localStorage','set','get','Item','cbolaDt','//web.archive.org/web/20190311102322/http://route.carambo.la/inimage/getlayer?pid=myky82&amp;did=112239&amp;wid=0')<input type="hidden" id="mkyong-postId" value="14948">

#### 关于作者

![author image](../Images/35dd984a924a95125253bc391292ca86.png)

##### mkyong

Founder of [Mkyong.com](http://web.archive.org/web/20190311102322/http://mkyong.com/), love Java and open source stuff. Follow him on [Twitter](http://web.archive.org/web/20190311102322/https://twitter.com/mkyong), or befriend him on [Facebook](http://web.archive.org/web/20190311102322/http://www.facebook.com/java.tutorial) or [Google Plus](http://web.archive.org/web/20190311102322/https://plus.google.com/110948163568945735692?rel=author). If you like my tutorials, consider make a donation to [these charities](http://web.archive.org/web/20190311102322/http://www.mkyong.com/blog/donate-to-charity/).
...
它在 Java 8 中可以工作，但是由于这个[和`count()`问题](http://web.archive.org/web/20220627214150/https://www.mkyong.com/java8/java-8-stream-the-peek-is-not-working-with-count/)，在 Java 9 和更高版本中‘peek()’将无法打印
...
*   [维基百科–ISO 8601 日期格式](http://web.archive.org/web/20220627214150/https://en.wikipedia.org/wiki/ISO_8601)
*   [Java–用 GMT](http://web.archive.org/web/20220627214150/https://www.mkyong.com/java/java-display-list-of-timezone-with-gmt/) 显示时区列表
*   [Java 8–如何对地图进行排序](http://web.archive.org/web/20220627214150/https://www.mkyong.com/java8/java-8-how-to-sort-a-map/)
*   [Java 8 流–peek()不支持 count()](http://web.archive.org/web/20220627214150/https://www.mkyong.com/java8/java-8-stream-the-peek-is-not-working-with-count/)
*   [Java 日期时间教程](http://web.archive.org/web/20220627214150/https://www.mkyong.com/tutorials/java-date-time-tutorials/)

<input type="hidden" id="mkyong-current-postId" value="14047">
> 原文:[http://web . archive . org/web/20230101150211/http://www . mkyong . com/struts 2/struts-2-sdoubleselect-example/](http://web.archive.org/web/20230101150211/http://www.mkyong.com/struts2/struts-2-sdoubleselect-example/)
...
![Struts 2 double select example](../Images/fa1b83088938363afba612e17f8aec9e.png "struts2-doubleselect-example-1")

*http://localhost:8080/struts 2 example/result action . action*

![Struts 2 double select example](../Images/e8cf852db9b81da60872a9834c29ea1f.png "struts2-doubleselect-example-2")
